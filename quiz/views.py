...
def upload_questions(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Process the uploaded Excel file and extract questions
            questions = parse_excel_and_extract_questions(excel_file)
            
            # Save the questions with the selected course
            for question_data in questions:
                Question.objects.create( course_id=course,**question_data)
